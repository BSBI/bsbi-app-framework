...
export const NATIONAL_STATUS_SCHEME_STATUS_SPONTANEOUS_NATIVE_X_NATIVE_HYBRID = 'b';
export const NATIONAL_STATUS_SCHEME_STATUS_SPONTANEOUS_NATIVE_X_ALIEN_HYBRID = 'd';
export const NATIONAL_STATUS_SCHEME_STATUS_SPONTANEOUS_ALIEN_X_ALIEN_HYBRID = 'k';
