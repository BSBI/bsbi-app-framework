...
var BSBIServiceWorker = /*#__PURE__*/function () {
  ...
  _createClass(BSBIServiceWorker, [{
    ...
    function initialise(configuration) {
      ...
      this.CACHE_VERSION = "version-1.0.2.1638008155-".concat(configuration.version);
